...
public class ChiTietSanPham {
    ...
    public ChiTietSanPham(String id, SanPham idsp, NSX idNsx, MauSac idmauSac, DongSP idDongSP, Integer namBh, String mota, Integer soluongTon, BigDecimal giaNhap, BigDecimal giaBan) {
        this.id = id;
        this.idsp = idsp;
        this.idNsx = idNsx;
